...
---
### 目标：  
做一个 CMS系统，后端采用 Node.js + MongoDB 实现，前端采用 Vue.js做单页应用
...
### 前端
- 建立 Vue.js单页应用项目
- 建立顶部导航，使用 vue router切换不同页面
- 使用 vue-resource获取后端 REST API数据        
- 使用 sass loader，在 vue应用里写 Sass
- 打包整个项目


> 根据前面所说的一些页面，可以想象有一些组件需要共享复用，比如 顶部导航拦，文章列表等
